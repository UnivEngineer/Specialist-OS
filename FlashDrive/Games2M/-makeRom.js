...
// Основные настройки
volumeSize    = 2048*1024       // Размер всего диска в байтах
chipSize      = 512*1024        // Размер одной микросхемы ПЗУ в байтах
maxFiles      = 192;            // Максимум файлов в корневом каталоге
volumeLabel   = "FLASH DISK "   // Метка тома, 11 символов
