...
Исходники `*.asm` и `*.inc` хранятся в UTF-8 без BOM. Тестовые файлы
`assets/games/Elite.txt` и `assets/system-rom/abcd0123.txt` предназначены для
самого «Специалиста» и сохраняются в KOI-8R.
