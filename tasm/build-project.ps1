...
$components = @(
    @{ Directory = "dos";    Source = "DOS";     Extension = "sys"; Address = "0xC000" },
    @{ Directory = "tape";   Source = "tape";    Extension = "com"; Address = "0xEC00" },
    @{ Directory = "flash";  Source = "Flash";   Extension = "com"; Address = "0xDE00" },
